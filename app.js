...
async function refreshDashboard(){
 ...
 dashboardView.innerHTML=`<div class="dash-head"><div><small>PERSONAL COMMAND CENTER</small><h1>Dashboard</h1><p>${new Date().toLocaleDateString(undefined,{weekday:"long",month:"long",day:"numeric"})}</p></div><button id="dQuick">＋ Quick Add</button></div>
