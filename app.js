...
const modules=[{key:"finance",name:"Net Worth",icon:"💰"},{key:"planes",name:"Planes Near Me",icon:"✈️"},{key:"travel",name:"Travel",icon:"🌎"},{key:"houses",name:"Houses",icon:"🏡"},{key:"shopping",name:"Groceries",icon:"🛒"},{key:"recipes",name:"Recipes",icon:"🍳"},{key:"prints",name:"3D Print List",icon:"🖨️"},{key:"shortGoals",name:"Goals",icon:"🎯"},{key:"longGoals",name:"Long-Term Goals",icon:"🏆"},{key:"projects",name:"Projects",icon:"🔨"},{key:"tasks",name:"Tasks",icon:"✅"}];
